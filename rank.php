...
<body>
	...
	<div class="wrap">
		...
		<div class="info">
			...
			echo "<table><tr><th>排名</th><th></th><th>名稱</th><th>作者</th><th></th><th></th></tr>";
			for ($i=0; $i < $rows; $i++) {
				if ($i<(($page*10)-10)) {
					continue;
				}
				...
				echo "<tr><td>$rank</td><td><img src='$path'/></td><td>$w_name</td><td>$u_name</td><td><p class='like'><a href='rank.php?like=1'>like</a></p></td><td><p class='dislike'><a href='rank.php?dislike=1'>dislike</a></p></td></tr>";
			}//sth to replace
			echo "</table>";
			echo "<ul class='pages'>";
			for($i=1;$i<=$pages;$i++){
